...
/**
 * Created by aramar1 on 6/11/16.
 */
public class UserTimeLineFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    //UserTimeLineFragment.newInstance("aramar1")
    ...
    private void populateTimeline(final long page) {
        ...
        twitterClient.getUsersTimeLine(page,screen_name ,new JsonHttpResponseHandler() {
            @Override
